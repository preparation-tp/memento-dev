...
sidebar_position: 3
title: "CP 3"
description: "Synthèse pour la CP 3 \"Réaliser des interfaces utilisateur statiques web ou web mobile\" du titre professionnel Développeur Web et Web Mobile (DWWM TP-01280m04)."
tags:
  - DWWM
  - Intégration
  - Responsive
...
<summary>Petit rappel sur le CSS</summary>
...
<summary>Petit rappel sur les attributs `aria-*`</summary>
...
<summary>Et le format SVG ? Ce n'est pas bien ?</summary>
...
<summary>Le cas de Bootstrap</summary>
...
Comme ça, adieu les 200Ko de CSS pour un site qui n'en fait que 20Ko ! 🚀
...
<Admonition type="example" title="Exemple concret">
