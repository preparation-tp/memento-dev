...
sidebar_position: 1
title: "CP 1"
description: "Synthèse de la CP 1 \"Installer et configurer son environnement de travail en fonction du projet web ou web mobile\" du titre professionnel Développeur Web et Web Mobile (DWWM TP-01280m04)."
tags:
  - DWWM
...
Tu devras alors expliquer comment installer PHP, Composer, Node.js, npm _(ou autre gestionnaire de dépendances Node)_
...
<Admonition type="info" title="Utilisation de XAMPP, WAMP, MAMP, LAMP, etc.">
...
<Admonition type="warning" title="Versions des outils et dépendances">
