...
> employee_has_task(<i class="italic">#employee_id</i>, <i class="italic">#task_id</i>);
...
[**Merise - Guide pratique (3e édition)](https://www.editions-eni.fr/livre/merise-guide-pratique-3e-edition-modelisation-des-donnees-et-des-traitements-manipulations-avec-le-langage-sql-9782409015342)
...
D'ailleurs, au moment de la rédaction je vois que la
[4ème édition](https://www.editions-eni.fr/livre/merise-guide-pratique-4e-edition-modelisation-des-donnees-et-des-traitements-manipulations-avec-le-langage-sql-conception-d-une-application-mobile-android-ou-ios-9782409046667)
est prévue pour le 9 octobre 2024... Comme on dit :

<ICalLink
  date="2024-10-09"
  title='Parution du livre "Guide pratique (4e édition)" aux Éditions ENI, de Jean-Luc Baptiste'
  description='<a href="https://www.editions-eni.fr/livre/merise-guide-pratique-4e-edition-modelisation-des-donnees-et-des-traitements-manipulations-avec-le-langage-sql-conception-d-une-application-mobile-android-ou-ios-9782409046667">Lien vers la page du produit</a>'
  className='px-4 py-2 bg-violet-100 dark:bg-violet-800 rounded-md'
>
  Save the date !
</ICalLink>